...
admin_route.get('/adminregister',auth.isLogoutadmin,adminController.adminRegistration)
...
//edit category page
admin_route.get('/editcategory',auth.isLoginadmin, adminController.editCategory)

//edit existing category
admin_route.post('/editcategory',auth.isLoginadmin,adminController.updateCategory)

//delete existing category
admin_route.get('/deletecategory',auth.isLoginadmin,adminController.deleteCategory)

//load orders page
admin_route.get('/orders',auth.isLoginadmin,adminController.loadOrders)

//load products in order
admin_route.get('/viewproducts',auth.isLoginadmin,adminController.OrderProducts)
...
admin_route.post('/addBanner',upload.single("badge"),bannerController.insertBanner)

admin_route.get('/editbanner',auth.isLoginadmin,bannerController.editBanner)

admin_route.post('/editbanner',upload.single("badge"),bannerController.updateBanner)
